...
export function Payment() {
  ...
  return (
    <div className="flex-1 p-6">
      ...
      <h2 className="text-white font-bold text-3xl mb-4 text-right bg-green-400 p-6">Valor total das vendas: R$ xxx,xx</h2>
            ...
            {payments.map((payment) => {
              ...
              return (
                <tr key={payment.id}>
                  ...
                  <td className="py-2 px-4">{payment.value}</td>
                  <td className="py-2 px-4">{payment.value * (seller?.commission_percentage ?? 0) / 100}</td>
